...
// Generar datos mensuales aleatorios
const mockMonthlyData = {
  ...
  cameras: Array.from({ length: 30 }, (_, i) => ({ day: i + 1, status: Math.random() > 0.2 ? 2 : 1 })), // 2 = on, 1 = off
    ...
    <ResponsiveContainer width="100%" height={200}>
      {isCamera ? (
        <LineChart data={data} margin={{ top: 20, right: 30, left: 0, bottom: 40 }}>
          ...
          <YAxis 
            stroke="#a3f0ba" 
            label={{ value: 'On / Off', angle: -90, position: 'insideLeft', offset: 10 }} 
            domain={[0, 2]}
          />
...
const Recommendations = () => (
  <div className="bg-futuristic-gray p-4 sm:p-6 rounded-3xl shadow-lg mx-auto" 
...
const AutoAIPilot = () => {
  ...
  return (
    <div
      className="bg-futuristic-gray p-4 sm:p-6 rounded-3xl shadow-lg flex flex-col space-y-3 mx-auto"
...
{/* Contenedor para Recommendations y Auto AI Pilot */}

    ...
    <div className="flex flex-col min-h-screen bg-gray-900 text-white">
      <main className="flex-grow p-4 sm:p-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
          {/* Lights Card */}
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-4 sm:p-6 rounded-3xl shadow-lg flex flex-col min-h-[220px]">
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Lights</h3>
          ...
          {/* Thermostats Card */}
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-4 sm:p-6 rounded-3xl shadow-lg flex flex-col min-h-[220px]">
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Thermostats</h3>
          ...
          {/* Cameras Card */}
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-4 sm:p-6 rounded-3xl shadow-lg flex flex-col min-h-[220px] items-center">
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Cameras</h3>
          ...
          {/* Locks Card */}
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-4 sm:p-6 rounded-3xl shadow-lg flex flex-col min-h-[220px] items-center">
            <h3 className="text-lg sm:text-xl font-semibold mb-4">Locks</h3>
        ...
        <div className="bg-gray-800 p-4 sm:p-6 rounded-3xl shadow-lg overflow-auto">

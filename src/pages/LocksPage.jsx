        ...
        <div className="space-y-6">
          {locks.map((lock) => (
            <div
              ...
              className="cursor-pointer bg-gradient-to-br from-gray-800 to-gray-900 p-6 rounded-3xl shadow-lg flex items-center justify-between hover:shadow-2xl transition min-h-[80px] gap-x-6"
            >
              {/* Name + Icon */}
              ...
              <span
                className={`px-6 py-3 text-sm rounded-full min-w-[90px] text-center ${

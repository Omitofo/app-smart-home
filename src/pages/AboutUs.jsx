      ...
      <div className="max-w-5xl mx-auto text-center">
        {activeTab === "who" && (
          <div>
            ...
            {/* 👇 Narrower text for readability */}
            <div className="max-w-2xl mx-auto">
              <p className="text-gray-300 mb-6 leading-relaxed">
                We are a team of passionate individuals dedicated to making
                smart homes accessible to everyone. Our expertise spans
        ...
        {activeTab === "mission" && (
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-gray-300 leading-relaxed">
              Our mission is to create a connected and intelligent home
              experience that is simple, secure, and sustainable. We strive to
              improve the quality of life by automating daily routines and
              saving energy.
            </p>
          </div>
        )}
        ...
        {activeTab === "what" && (
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-gray-300 leading-relaxed">
              Our apps allow users to control and monitor their home devices
